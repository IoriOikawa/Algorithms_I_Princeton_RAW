...
public class Solver {
    ...
    private SearchNode solutionNode;
     ...
     // Finding a solution to the initial board...
    ...
    public Solver(Board initial) {
        ...
        while (true) {
            ...
            // Inserting each neighbor except the board of the previous search node...
    ...
    public Iterable<Board> solution() {
     ...
     // Solver test client, given by Princeton's algs4.
